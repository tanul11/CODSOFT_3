...
#label
label1 = Label(root, text = "WIND", font = ("Helvetica", 15, 'bold'), fg = 'yellow', bg = '#1ab5ef')
label1.place(x = 120, y = 400)


label2 = Label(root, text = "HUMIDITY", font = ("Helvetica", 15, 'bold'), fg = 'yellow', bg = '#1ab5ef')
label2.place(x = 250, y = 400)


label3 = Label(root, text = "DESCRIPTION", font = ("Helvetica", 15, 'bold'), fg = 'yellow', bg = '#1ab5ef')
label3.place(x = 430, y = 400)


label4 = Label(root, text = "PRESSURE", font = ("Helvetica", 15, 'bold'), fg = 'yellow', bg = '#1ab5ef')
